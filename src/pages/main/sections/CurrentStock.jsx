  ...
  return (
    <>
      <section className="currentStockDIV">
        ...
        <a href="/showroom">
          <button type="button" className="buttonDefault exploreMore">
            EXPLORE MORE
          </button>
        </a>
      </section>
